...
| `vimar_intercom.find_sga` | Cerca il PICG mandando `GET_NICKS` a un intervallo di indirizzi (issue #14) | `start`, `end`, `targets`, `probe`, `delay`, `reply_wait`, `sip_timeout`, `apply`, `apply_sga` |
